...
const Posts = () => {
    ...
    if (error && allPosts.length === 0) {
        return (
            <div className="bg-[#182237] my-3 p-5 rounded-lg text-sm h-[530px]">
    ...
    if (isFetching && allPosts.length === 0) {
        return (
            <div className=" flex flex-col bg-[#182237] my-3 p-5 rounded-lg text-sm h-[530px]">
                <div className="flex items-center justify-between">
                    <Search placeholder="Search for a post" />
                    <Link
                        href="/posts/add-post"
    ...
    return (
        <div className="flex flex-col bg-[#182237] my-3 p-5 rounded-lg text-sm min-h-[530px]">
            <div className="flex items-center justify-between">
